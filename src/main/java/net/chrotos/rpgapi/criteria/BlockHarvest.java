...
@Getter
@SuperBuilder
public class BlockHarvest extends Criterion implements Checkable<Block> {
    /**
     * The materials, of the block to be harvested. All are substitutes.
     */
    @Singular("material")
    ...
    public TranslatableComponent getGuiName() {
        return Component.translatable("quest.criteria.block_harvest");
    }
}
